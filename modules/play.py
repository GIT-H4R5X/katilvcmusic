...
async def ytplay(_, message: Message):
        ...
        [
            ...
            [
                InlineKeyboardButton(
                    "☑️ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/heartbrokenperson1"
                ),
                InlineKeyboardButton("ꜱᴜᴘᴘᴏʀᴛ ⚡", url=f"https://t.me/FULL_MASTI_CLUBS"),
            ],
        ]
    )
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="☑️ KATIL ᴜꜱᴇʀ ʙʏ {} 😎".format(
...
@Client.on_message(filters.command("kplay") & filters.group & ~filters.edited)
async def jiosaavn(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        ...
        reply_markup=keyboard,
        photo="final.png",
        caption=f"katil ᴜꜱᴇʀ ʙʏ {sname} Via saavn",
    )
    os.remove("final.png")

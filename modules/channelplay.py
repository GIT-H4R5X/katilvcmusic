...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/d7756c7a75ff0eeeb3208.jpg"
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>Playing</b> the song requested by {} via Zaid Music 😎 in Linked Channel".format(
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        sthumb = https://telegra.ph/file/d7756c7a75ff0eeeb3208.jpg"
        ...
        [
            ...
            [
                InlineKeyboardButton(
                    text="Join Channel", url=f"https://t.me/heartbrokenperson1"
                )
            ]
        ]
    )
    ...
    m = await client.send_photo(
        ...
        reply_markup=keyboard,
        photo="final.png",
        caption=f"Playing {sname} Via Katilsaavn in linked channel",
    )
    os.remove("final.png")
